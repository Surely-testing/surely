...
import { AIResponseInsights } from './AIResponseInsights';
...
export const SingleAPIRequest: React.FC<SingleAPIRequestProps> = ({ 
  ...
  const handleApplySuggestion = (suggestion: Partial<RequestConfig>) => {
    setConfig({ ...config, ...suggestion });
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {response && (
        <div className="space-y-4">
          ...
          <AIResponseInsights response={response} />
