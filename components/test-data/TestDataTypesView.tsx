      ...
      <div className="mx-auto py-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between gap-4 mb-6">
            ...
            <button
              onClick={onCreateNew}
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-foreground bg-primary rounded hover:bg-primary/90 transition-colors whitespace-nowrap"
            >
